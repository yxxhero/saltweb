...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'chatmodel'
        db.create_table(u'saltweb_chatmodel', (
            ...
            ('chatcontent', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'saltweb', ['chatmodel'])


    def backwards(self, orm):
        # Deleting model 'chatmodel'
        db.delete_table(u'saltweb_chatmodel')
    ...
    models = {
        ...
        u'saltweb.chatmodel': {
            'Meta': {'object_name': 'chatmodel'},
            'chatcontent': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'createtime': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
