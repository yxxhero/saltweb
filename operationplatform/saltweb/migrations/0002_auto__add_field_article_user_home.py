...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'article.user_home'
        db.add_column(u'saltweb_article', 'user_home',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2016, 11, 19, 0, 0), max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'article.user_home'
        db.delete_column(u'saltweb_article', 'user_home')
